...
<body>
    ...
    <div class = "centreContainer">  
        <form action = "SavePerson.php" name="form" method="post" class = "row"> 
            ...
            Expiry <input type="date" name="CardExpiry" placeholder="card expiry" 
                ...
                <p><input type="tel" name="Phone" placeholder="phone number" 
                    ...
                    required value="<?php echo $row['City'];?>" />
                    <input type="text" name="Province" placeholder="province" 
                    required value="<?php echo $row['Province'];?>" />
                    <input type="text" name="citizenship" placeholder="citizenship" 
                    required value="<?php echo $row['citizenship'];?>" /></p>
                    <p>Birth date <input type="date" name="DateOfBirth" placeholder="date of birth" 
