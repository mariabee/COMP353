...
while($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td align="center">
                        <a href="editInfections.php?id=<?php echo $row["ID"]; ?>" class="green_bg">View/Edit</a>
                    </td>
                    </td>
                    <td align="center">
                        <a href="deleteInfections.php?id=<?php echo $row["ID"]; ?>&Date=<?php echo $row["Date"]; ?>" class="dark_bg">Delete</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
